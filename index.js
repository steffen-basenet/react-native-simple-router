...
class Router extends React.Component {
    ...
    renderScene(route, navigator) {
        ...
        return ( <
            View style = {
                [styles.container, this.props.bgStyle, extraStyling, { marginTop: margin }] } >
            <
            ...
            customAction = { customAction } {...route.passProps }
            /> <
            /View>
        );
    }
    ...
    render() {
        ...
        if (!this.props.hideNavigationBar) {
            navigationBar = ( <
                NavBarContainer style = { this.props.headerStyle }
                navigator = { navigator }
